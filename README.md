...
~~~sh
# getting the code
git clone git@github.com:nko5/mj2b.git && cd ./mj2b/
...
# deploying to Modulus (to http://mj2b.2015.nodeknockout.com/)
modulus deploy
...
~~~html
<iframe src="http://nodeknockout.com/iframe/mj2b" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
